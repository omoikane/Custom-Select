...
(function($){
	...
	$.fn.customselect = function(callback) {
		return this.each(function(){
			...
			enhanced.append('<div class="selectBox"><div class="selectContent"><div class="selectList"><span>' + $("option:selected", that).text() + '</span></div><span class="selectArrow">test</span></div><ul></ul></div>');
